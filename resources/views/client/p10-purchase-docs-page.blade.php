...
@section('title')
    Documentation > P10 Purchase (Crypto POS)
    @php
        ...
        <div class="col-xl-12 mt-3 d-flex flex-column flex-lg-row gap-5">
                ...
                <ol class="steps">
                    ...
                    <li class="step completed">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">POST: </span> <a href="#">
                                    https://payment.ryzen-pay.com/api/payment/{accId}/p10/purchase/checkout </a></p>
                                        ...
                                        <div class="box-content">
                                            <p>
                                                ...
                                                <span class="blue-text-color">[<br>
                                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'fiatAmount'</span> <span class="pink-text">=></span>7.99,&nbsp; <span class="comment-text">// REQUIRED</span><br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'fiatCurrency'</span> <span class="pink-text">=></span>'USD',&nbsp; <span class="comment-text">// REQUIRED<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'title'</span> <span class="pink-text">=></span>'My Company Name',&nbsp; <span class="comment-text">// REQUIRED<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'siteName'</span> <span class="pink-text">=></span>'abc.co.in',&nbsp; <span class="comment-text">// Optional<br></span>
                                                        <span>
                                                            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                            &nbsp;]
                                                        </span><br>
                                        ...
                                        <div class="box-content">
                                            <p>
                                                ...
                                                <span class="blue-text-color">{<br>
                                                    ...
                                                    <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp; &nbsp;
                                                        &nbsp;"from_amount":</span><span class="blue-text-color">
                                                        7.99,</span><br>
                                                    <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp; &nbsp;
                                                        &nbsp;"from_currency":</span><span class="blue-text-color">
                                                        "USD",</span><br>
                                                    <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp;
                                                        &nbsp;
                                                        &nbsp;"checkout_id":</span><span class="blue-text-color">
                                                        "014504dc-016d-43f7-3358-451cc70ea024"</span><br>
                                                    <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp; &nbsp;
                                                        &nbsp;"link":</span><span class="blue-text-color">
                                                        "https://wwww.paymentpage.com/site/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1",</span><br>
                                                    <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp;
                                                        &nbsp;
                                                        &nbsp;"token":</span><span class="blue-text-color">
                                                        "20178072-1698-4588-ba84-dabc078d7209"</span><br>
                                                    <span>
                                                        &nbsp; &nbsp;}
                                                    </span><br>
                                                </span>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            proceeding to payment page in Step 1</p>
                        </div>
                    </li>
                    <li class="step completed mt-5 mt-lg-0">
                        <div class="marker"></div>
                        <div class="body">
                            <h4 class="fw-bold">Step 3: </h4><br>
                            When transaction process is completed, we will send a Webhook request to you, containing the {checkout_id} of the transaction . The webhook request will be sent in the following format:
                            <p><span class="fw-bold">GET: </span> <a href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p10/purchase/{checkout_id}</a></p>
                            <p><span class="fw-bold">EXAMPLE: </span>
                                https://www.examplesite.com/api/RyzenPay/p10/purchase/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1
                            </p>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href=""><your-base-url>https://payment.ryzen-pay.com/api/payment/{accId}/p10/purchase/getPaymentStatus/{checkout_id}</a>
                            </p>
                        </div>
                                ...
                                <div class="box-content">
                                    <p>
                                        <span class="blue-text-color">{<br>
                                            ...
                                            </span><span class="blue-text-color"> "Unauthorized Checkout Id or  Transaction is not completed.",</span><br>
                                            <span class="blue-text-color">
                                                &nbsp;}
                                            </span><br>
                                            <!-- <span> &nbsp; &nbsp;Today</span> -->
            ...
            <div class="right-section">
                        ...
                        <div class="box-header d-flex justify-content-between">
                         ...
                         <div class="box-content">
                                            <p>
                                                ...
                                                <span class="blue-text-color">[<br>
                                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'fiatAmount'</span> <span
                                                            class="pink-text">=></span>
                                                        7.99,<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'fiatCurrency'</span> <span
                                                            class="pink-text">=></span>
                                                        'EUR',<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'title'</span> <span
                                                            class="pink-text">=&gt;</span> "Company ABC",<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'siteName'</span> <span
                                                            class="pink-text">=&gt;</span> "www.abc.co.in", // optional<br></span>
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <button type="button" class="copy-btn" aria-label="Copy response">
                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15.8416 2.60449H11.9476C10.1836 2.60449 8.78556 2.60449 7.69256 2.75249C6.56656 2.90449 5.65556 3.22449 4.93756 3.94549C4.21856 4.66649 3.89956 5.58149 3.74856 6.71149C3.60156 7.80949 3.60156 9.21249 3.60156 10.9835V16.8215C3.60156 18.3295 4.52156 19.6215 5.82856 20.1635C5.76156 19.2535 5.76156 17.9785 5.76156 16.9165V11.9065C5.76156 10.6255 5.76156 9.52049 5.87956 8.63649C6.00656 7.68849 6.29256 6.78049 7.02656 6.04349C7.76056 5.30649 8.66556 5.01949 9.60956 4.89149C10.4896 4.77349 11.5896 4.77349 12.8666 4.77349H15.9366C17.2126 4.77349 18.3106 4.77349 19.1916 4.89149C18.9277 4.21779 18.4669 3.63923 17.8693 3.23128C17.2717 2.82332 16.5651 2.6049 15.8416 2.60449Z" fill="black" />
                                        <path d="M7.20312 12.0013C7.20312 9.27526 7.20312 7.91226 8.04712 7.06526C8.89012 6.21826 10.2471 6.21826 12.9631 6.21826H15.8431C18.5581 6.21826 19.9161 6.21826 20.7601 7.06526C21.6041 7.91226 21.6031 9.27526 21.6031 12.0013V16.8213C21.6031 19.5473 21.6031 20.9103 20.7601 21.7573C19.9161 22.6043 18.5581 22.6043 15.8431 22.6043H12.9631C10.2481 22.6043 8.89012 22.6043 8.04712 21.7573C7.20312 20.9103 7.20312 19.5473 7.20312 16.8213V12.0013Z" fill="black" />
                                    </svg>
                                </button>
                ...
                <div id="step2" class="d-none d-lg-block bottom-headers">
                    <p><span class="fw-bold">GET: </span> <a
                            href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p10/purchase/{checkout_id}</a>
                    </p>
