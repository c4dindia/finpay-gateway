        ...
        <div class="col-xl-12 mt-3 d-flex flex-column flex-lg-row gap-5">
                ...
                <ol class="steps">
                    ...
                    <li class="step completed">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold"> Link: </span><a href="{{ asset('docs/smile-supported-countries.docx') }}">Supported countries and currencies list</a></p>
                            <p><span class="fw-bold">POST: </span> <a href="#">
                                    https://payment.ryzen-pay.com/api/payment/{accId}/p15/checkout </a></p>
                                        ...
                                        <div class="box-content">
                                            <p>
                                                ...
                                                <span class="blue-text-color">[<br>
                                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'first_name'</span> <span class="pink-text">=></span> 'John',&nbsp; <span class="comment-text">// REQUIRED</span><br></span>
                                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'last_name'</span> <span class="pink-text">=></span> 'Doe',&nbsp; <span class="comment-text">// REQUIRED</span><br></span>
                                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'email'</span> <span class="pink-text">=></span> 'john.doe@gmail.com',&nbsp; <span class="comment-text">// REQUIRED</span><br></span>
                                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'phone'</span> <span class="pink-text">=></span> '254161166649',&nbsp; <span class="comment-text">// REQUIRED (With Country Code)</span><br></span>
                                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'amount'</span> <span class="pink-text">=></span> '7.99',&nbsp; <span class="comment-text">// REQUIRED</span><br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'currency'</span> <span class="pink-text">=></span> 'KES',&nbsp; <span class="comment-text">// REQUIRED (Check supported list)<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'country_id'</span> <span class="pink-text">=></span> 1,&nbsp; <span class="comment-text">// REQUIRED (Check supported list)<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'business_name'</span> <span class="pink-text">=></span> 'Test',&nbsp; <span class="comment-text">// REQUIRED<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'item_name'</span> <span class="pink-text">=></span> 'Test',&nbsp; <span class="comment-text">// REQUIRED<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'logo'</span> <span class="pink-text">=></span> 'data:image/png;base64',&nbsp; <span class="comment-text">// REQUIRED (Use the base64 encoded file of maximum 2MB)<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'redirection_url'</span> <span class="pink-text">=></span> 'https://www.mywebsite.com',&nbsp; <span class="comment-text">// OPTIONAL<br></span>
                                        ...
                                        <div class="box-content">
                                            <p>
                                                ...
                                                <span class="blue-text-color">{<br>
                                                    ...
                                                    <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp; &nbsp;
                                                        &nbsp;"amount":</span><span class="blue-text-color">
                                                        "7.99",</span><br>
                                                    <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp;
                                                        &nbsp;
                                                        &nbsp;"currency":</span><span class="blue-text-color">
                                                        "KES",</span><br>
                                                    <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp;
                                                        &nbsp;
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p15/{checkout_id}</a></p>
                            <p><span class="fw-bold">EXAMPLE: </span>
                                https://www.examplesite.com/api/RyzenPay/p15/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1
                            </p>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href=""><your-base-url>https://payment.ryzen-pay.com/api/payment/{accId}/p15/getPaymentStatus/{checkout_id}</a>
                            </p>
                        </div>
            ...
            <div class="right-section">
                        ...
                        <div class="box-content">
                            <p>
                                ...
                                <span class="blue-text-color">{<br>
                                    ...
                                    <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp; &nbsp;
                                        &nbsp;"amount":</span><span class="blue-text-color"> "7.99",</span><br>
                                    <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                                        &nbsp;
                                        &nbsp;"currency":</span><span class="blue-text-color">
                                        "KES",</span><br>
                ...
                <div id="step2" class="d-none d-lg-block bottom-headers">
                    <p><span class="fw-bold">GET: </span> <a
                            href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p15/{checkout_id}</a>
                    </p>
