    ...
    <div class=" p-3">
        <!-- <h4 class="text-center"
                                                                                                                                                                                                                                                                    style="Font-family:Poppins; font-weight: 400; font-size:40px; line-height: 60px; letter-spacing: 0%;"> <i
                                                                                                                                                                                                                                                                        class="fa-regular fa-credit-card"></i>&nbsp;P2 Services</h4> -->
            ...
            <div class="left-section progress-vertical">
                <ol class="steps">
                    <li class="step completed">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">POST: </span> <a href="#">
                                    https://payment.ryzen-pay.com/api/payment/{accId}/p2/checkout </a></p>
                            ...
                            <div id="step1" class="d-lg-none">
                                ...
                                <div class="header-wrapper mt-4">
                                    ...
                                    <div class="box-header d-flex justify-content-between mt-lg-5">
                                            ...
                                            <p>
                                                ...
                                                <span class="blue-text-color font-500">{<br>
                                                    ...
                                                    <span class="pink-text font-500">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        ...
                                                        "https://payment.ryzen-pay.com/payment/p2/payment-page/5B7F4F2863xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx4"</span><br>
                                                    <span>
                                                        &nbsp; &nbsp;}
                                                    </span><br>
                                                </span>
                    ...
                    <li class="step completed">
                        <div class="marker"></div>
                        <div class="body">
                            <h4 class="fw-bold">Step 3: </h4><br>When transaction process is completed, we will send a
                            Webhook
                            request
                            to you, containing the {checkout_id} of the transaction . The webhook request will be sent in
                            the
                            following
                            format:</p>
                            <p><span class="fw-bold">GET: </span> <a
                                    href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p2/{checkout_id}</a></p>
                            <p><span class="fw-bold">EXAMPLE: </span>
                                https://www.examplesite.com/api/RyzenPay/p2/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1</p>
                            ...
                            <br>
                            <p> In this request, you can call our GetPaymentStatus API to retrieve Transaction Details
                                for
                                the
                                checkout_id. Make sure, the request should always return <span class="fw-bold">200
                                    STATUS.</span>
                            </p>
                        </div>
                    </li>
                    ...
                    <li class="step completed">
                        <div class="marker"></div>
                        <div class="body">
                            <h4 class="fw-bold mt-5 mt-lg-0">GetPaymentStatus API </h4>
                            </p>
                            <p class="mb-0">Get the status and details of the transaction using the
                                <span>{checkout_id}</span> .
                            </p>
                            <p><span class="fw-bold">GET: </span> <a
                                    href=""><your-base-url>https://payment.ryzen-pay.com/api/payment/{accId}/p2/getPaymentStatus/{checkout_id}</a>
                            </p>

                            <div id="step2" class="d-lg-none">
                                <div class="header-wrapper mt-4">

                                    <div class="box-header d-flex justify-content-between mt-1">
                                ...
                                <div class="header-wrapper mt-4">
                                    <div class="box-header d-flex justify-content-between">
                                        ...
                                        <p class="mb-0 font-500">Response: 200 OK (If Transaction process is completed)
                                        </p>
                                        <div class="d-flex gap-2 align-items-center">
                                            <span>copy</span>
                                            <button type="button" class="copy-btn" aria-label="Copy response">
                                        ...
                                        <p>
                                            ...
                                            <span class="blue-text-color font-500">{<br>
                                                <span class="pink-text font-500"> &nbsp; &nbsp; &nbsp;
                                                    ...
                                                    &nbsp;&nbsp;
                                                    &nbsp;
                                                    &nbsp;"amount"</span><span class="pink-text font-500"> =>
                                ...
                                <div class="header-wrapper mt-4 mb-2">
                                    <div class="box-header d-flex justify-content-between">


                                        <p class="mb-0 font-500">Response: 401 Unauthorized (If Transaction process
                                            didn't
                                            complete)
                                        </p>
                                        <div class="d-flex gap-2 align-items-center">
                                        ...
                                        <p>
                                            ...
                                            <span class="blue-text-color font-500">{<br>
                                                <span class="pink-text font-500"> &nbsp; &nbsp; &nbsp;
                                                    ...
                                                    "Unauthorized Checkout Id or Transaction is not
                                                    completed.",</span><br>
                                                <span class="blue-text-color font-500">
                                                    &nbsp;}
                                                </span><br>
                ...
                <div id="step1" class="d-none d-lg-block">
                    <div class="px-2 group-1">
                        <p><span class="fw-bold">POST: </span>
                            <a href="#">https://payment.ryzen-pay.com/api/payment/{accId}/p2/checkout</a>
                        </p>
                    </div>
                    ...
                    <div id="step2" class="d-none d-lg-block">
                        <div class="px-2 bottom-headers">
                            <p><span class="fw-bold">GET: </span>
                                <a href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p2/{checkout_id}</a>
                            </p>
                        </div>
                        <div class="header-wrapper mt-1">
