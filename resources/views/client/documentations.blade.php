...
@section('page-content')
    <div class="row doc-grid mx-0 px-2 pe-2 mt-3">
        ...
        @if (!empty($p23detail->status))
            ...
            @if (!empty($p23detail->midv3))
                <!-- Pay-In-Link Upipay V3 -->
                <div class="col-12 col-sm-6 col-xl-4 py-3">
                    <div class="doc-card">
                        <a href="{{ route('p23v3DocPage') }}" class="fd-docTile">
                            <div class="fd-docTile__top">
                                <span class="fd-docTile__icon" aria-hidden="true">
                                    <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div class="fd-docTile__title">Pay-In-Link (Upi .v3)</div>
                        </a>
                    </div>
                </div>
            @endif
        ...
        @if (!empty($p24detail->status))
            <!-- Pay-In-Link Atompay (UPI ATM) -->
            <div class="col-12 col-sm-6 col-xl-4 py-3">
                <div class="doc-card">
                    <a href="{{ route('p24DocPage') }}" class="fd-docTile">
                        <div class="fd-docTile__top">
                            <span class="fd-docTile__icon" aria-hidden="true">
                                <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="fd-docTile__title">Pay-In-Link (Upi ATM)</div>
                    </a>
                </div>
            </div>
        @endif

        @if (!empty($p25detail->status))
            <!-- Pay-In-Link Paynora (UPI PYN) -->
            <div class="col-12 col-sm-6 col-xl-4 py-3">
                <div class="doc-card">
                    <a href="{{ route('p25DocPage') }}" class="fd-docTile">
                        <div class="fd-docTile__top">
                            <span class="fd-docTile__icon" aria-hidden="true">
                                <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="fd-docTile__title">Pay-In-Link (Upi PYN)</div>
                    </a>
                </div>
            </div>
        @endif
