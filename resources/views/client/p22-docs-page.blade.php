        ...
        <div class="col-xl-12 mt-3 d-flex flex-column flex-lg-row gap-5">
                ...
                <ol class="steps">
                    ...
                    <li class="step completed">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">POST: </span> <a href="#">
                                    https://payzone.finpay.group/api/payment/{accId}/p22/checkout </a></p>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href="#">https://&lt;your-base-url&gt;/api/finpay/p22/{checkout_id}</a></p>
                            <p><span class="fw-bold">EXAMPLE: </span>
                                https://www.examplesite.com/api/finpay/p22/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1
                            </p>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href=""><your-base-url>https://payzone.finpay.group/api/payment/{accId}/p22/getPaymentStatus/{checkout_id}</a>
                            </p>
            ...
            <div class="right-section">
                <div id="step1" class="d-none d-lg-block">
                    <p class="px-2"><span class="fw-bold">POST: </span> <a href="#"> https://payzone.finpay.group/api/payment/{accId}/p22/checkout </a></p>
