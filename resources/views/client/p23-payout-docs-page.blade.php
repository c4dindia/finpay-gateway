...
@section('title')
Documentation > P23-Payout Service
@php
    ...
    <div class="col-xl-12 mt-3 d-flex flex-column flex-lg-row gap-5">
            ...
            <ol class="steps">
                ...
                <li class="step completed">
                    ...
                    <div class="body">
                        ...
                        <p><span class="fw-bold">POST: </span> <a href="#">
                                https://payzone.finpay.group/api/payout/{accId}/p23/checkout </a></p>
                            ...
                            <div class="header-wrapper mt-4">
                                ...
                                <div class="box-content">
                                    <p>
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'name'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'John Doe',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required</span><br>

                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'email'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'john.doe@example.com',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required</span><br>

                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'phone'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'9876543210',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required </span><br>

                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'bankName'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'John Doe',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required</span><br>

                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'accountNo'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'1234567890',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required</span><br>

                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'ifscCode'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'ABCD0123456',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required</span><br>

                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'modeOfPayment'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'IMPS',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required [IMPS, NEFT, RTGS]</span><br>
                            ...
                            <div class="header-wrapper mt-4">
                                ...
                                <div class="box-content">
                                    <p>
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">"order_id":</span>
                                        <span class="blue-text-color">"Ordxabc123...",</span><br>
                ...
                <li class="step completed mt-5 mt-lg-0">
                    ...
                    <div class="body">
                        ...
                        <p><span class="fw-bold">GET: </span> <a
                                href="#">https://&lt;your-base-url&gt;/api/finpay/p23/{checkout_id}</a></p>
                        <p><span class="fw-bold">EXAMPLE: </span>
                            https://www.examplesite.com/api/finpay/p23/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1
                        </p>
                ...
                <li class="step completed mt-5 mt-lg-0">
                    ...
                    <div class="body">
                        ...
                        <p><span class="fw-bold">GET: </span> <a
                                href=""><your-base-url>https://payzone.finpay.group/api/payment/{accId}/p23/getPaymentStatus/{checkout_id}</a>
                        </p>
        ...
        <div class="right-section">
            <div id="step1" class="d-none d-lg-block">
                <p class="px-2"><span class="fw-bold">POST: </span> <a href="#"> https://payzone.finpay.group/api/payout/{accId}/p23/checkout </a></p>
