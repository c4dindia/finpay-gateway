        ...
        <div class="col-xl-12 mt-3 d-flex flex-column flex-lg-row gap-5">
                ...
                <ol class="steps">
                    ...
                    <li class="step completed">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">POST: </span> <a href="#">
                                    https://payment.ryzen-pay.com/api/payment/{accId}/p16/checkout </a></p>
                                        ...
                                        <div class="box-content">
                                            <p>
                                                ...
                                                <span class="blue-text-color">[<br>
                                                    ...
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'returnUrl'</span> <span class="pink-text">=></span>'https://www.mywebsite.com/thankyou',&nbsp; <span class="comment-text">// OPTIONAL<br></span>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p16/{checkout_id}</a></p>
                            <p><span class="fw-bold">EXAMPLE: </span>
                                https://www.examplesite.com/api/RyzenPay/p16/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1
                            </p>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href=""><your-base-url>https://payment.ryzen-pay.com/api/payment/{accId}/p16/getPaymentStatus/{checkout_id}</a>
                            </p>
                        </div>
            ...
            <div class="right-section">
                ...
                <div id="step2" class="d-none d-lg-block bottom-headers">
                    <p><span class="fw-bold">GET: </span> <a
                            href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p16/{checkout_id}</a>
                    </p>
