                    ...
                    <li class="step completed">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">POST: </span> <a href="#">
                                    https://payment.ryzen-pay.com/api/payment/{accId}/p8/checkout </a></p>
                                                ...
                                                <span class="blue-text-color">[<br>
                                                    ...
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'firstName'</span> <span
                                                            class="pink-text">=&gt;</span> "Harry",<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'lastName'</span> <span
                                                            class="pink-text">=&gt;</span> "Doe",<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'email'</span> <span
                                                            class="pink-text">=&gt;</span> "harr2y@mail.co.uk",<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'dateOfBirth'</span> <span
                                                            class="pink-text">=&gt;</span> "1980-01-01",<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'address'</span> <span
                                                            class="pink-text">=&gt;</span> '80 Neal Street Covent
                                                        Garden',<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'city'</span> <span
                                                            class="pink-text">=&gt;</span> 'London',<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'state'</span> <span
                                                            class="pink-text">=&gt;</span> 'London',<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'postCode'</span> <span
                                                            class="pink-text">=&gt;</span> "WC2E 9DD",<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'country'</span> <span
                                                            class="pink-text">=&gt;</span> 'GB',<br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'successRedirectUrl'</span> <span
                                                            class="pink-text">=&gt;</span>
                                                        "https://www.your-site.com/successful-link",<span
                                                class="comment-text"> //Optional</span><br></span>
                                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        &nbsp;<span class="pink-text">'failRedirectUrl'</span> <span
                                                            class="pink-text">=&gt;</span>
                                                        "https://www.youtube.com/unsuccessful-link" <span
                                                class="comment-text"> //Optional</span><br></span>
                                                    <span>
                                                        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;]
                                                    </span><br>
                                            ...
                                            <p>
                                                ...
                                                <span class="blue-text-color">{<br>
                                                    ...
                                                    <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        ...
                                                        "https://payment.ryzen-pay.com/payment/p8/payment-page/b42ff3e1-a854-44xx-xxxx-xxxxxxxb3637c",</span><br>
                                                    <span>
                                                        &nbsp; &nbsp;}
                                                    </span><br>
                                                </span>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p8/{checkout_id}</a></p>
                            <p><span class="fw-bold">EXAMPLE: </span>
                                https://www.examplesite.com/api/RyzenPay/p8/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1
                            </p>
