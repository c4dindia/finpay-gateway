...
@section('title')
Documentation > P23-Payin Service
@php
    ...
    <div class="col-xl-12 mt-3 d-flex flex-column flex-lg-row gap-5">
            ...
            <ol class="steps">
                ...
                <li class="step completed">
                    ...
                    <div class="body">
                        ...
                        <p><span class="fw-bold">POST: </span> <a href="#">
                                https://payzone.finpay.group/api/payment/{accId}/p23/v3/checkout </a></p>
                                ...
                                <div class="box-content">
                                    <p>
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'method'</span> <span
                                            ...
                                            class="comment-text">// Required [QR, UPI]</span><br>

                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'url'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'https://example.com',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required</span><br>

                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'description'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'test payment',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required</span><br>

                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'mobile'</span> <span
                                            class="pink-text">=></span> <span
                ...
                <li class="step completed mt-5 mt-lg-0">
                    ...
                    <div class="body">
                        ...
                        <p><span class="fw-bold">GET: </span> <a
                                href=""><your-base-url>https://payzone.finpay.group/api/payment/{accId}/p23/v3/getPaymentStatus/{checkout_id}</a>
                        </p>
        ...
        <div class="right-section">
            <div id="step1" class="d-none d-lg-block">
                <p class="px-2"><span class="fw-bold">POST: </span> <a href="#"> https://payzone.finpay.group/api/payment/{accId}/p23/v3/checkout </a></p>
