    ...
    <div class=" p-3">
        <div class="col-xl-12 mt-3 d-flex flex-column flex-lg-row gap-5">
                ...
                <ol class="steps">
                    ...
                    <li class="step completed">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">POST: </span> <a href="#">
                                    https://payment.ryzen-pay.com/api/payment/{accId}/p4/checkout </a></p>
                                    ...
                                    <div class="box-content">
                                        <p>
                                            ...
                                            <span class="blue-text-color">[<br>
                                                ...
                                                <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                    &nbsp;<span class="pink-text">'first_name'</span> <span
                                                        class="pink-text">=></span>
                                                    'Poppy',<br></span>
                                                <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                    &nbsp;<span class="pink-text">'last_name'</span> <span
                                                        class="pink-text">=></span>
                                                    'Chao',<br></span>
                                                <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                    &nbsp;<span class="pink-text">'nationality'</span> <span
                                                        class="pink-text">=></span>
                                                    'IND',<br></span>
                                                <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                    &nbsp;<span class="pink-text">'country_of_residence'</span> <span
                                                        class="pink-text">=></span> 'GBR',<br></span>
                                                <span>
                                                    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;]
                                                </span><br>
                                            </span>
                                        ...
                                        <p>
                                            ...
                                            <span class="blue-text-color">{<br>
                                                ...
                                                <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                    ...
                                                    "https://payment.ryzen-pay.com/payment/p4/payment-page/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1",</span><br>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p4/{checkout_id}</a></p>
                            <p><span class="fw-bold">EXAMPLE: </span>
                                https://www.examplesite.com/api/RyzenPay/p4/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1
                            </p>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href=""><your-base-url>https://payment.ryzen-pay.com/api/payment/{accId}/p4/getPaymentStatus/{checkout_id}</a>
                            </p>
                            ...
                            <div id="step2" class="d-lg-none">
                                ...
                                <div class="header-wrapper mt-4">
                                    ...
                                    <div class="box-header d-flex justify-content-between">
                                        ...
                                        <p class="mb-0 font-500">Response: 200 OK (If Transaction
                                            process is
                                            completed)</p>
                                        <div class="d-flex gap-2 align-items-center">
                                            <span>copy</span>
                                ...
                                <div class="header-wrapper mt-4">
                                    ...
                                    <div class="box-header d-flex justify-content-between">
                                        ...
                                        <p class="mb-0 font-500">Response: 401 Unauthorized (If
                                            Transaction
                                            process
                                            didn't complete)</p>
                                        <div class="d-flex gap-2 align-items-center">
                                        ...
                                        <p>
                                            ...
                                            <span class="blue-text-color">{<br>
                                                <span class="pink-text"> &nbsp; &nbsp; &nbsp;
                                                    ...
                                                    =>
                                                </span><span class="blue-text-color"> "Unauthorized
                                                    Checkout Id
                                                    or
                                                    Transaction is not
                                                    completed.",</span><br>
            ...
            <div class="right-section">
                            ...
                            <p>
                                ...
                                <span class="blue-text-color">[<br>
                                    ...
                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        ...
                                        'monster288@gmail.com',<br></span>
                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'first_name'</span> <span class="pink-text">=></span>
                                        'Poppy',<br></span>
                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'last_name'</span> <span class="pink-text">=></span>
                                        'Chao',<br></span>
                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'nationality'</span> <span class="pink-text">=></span>
                                        'IND',<br></span>
                                    <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'country_of_residence'</span> <span
                                            class="pink-text">=></span> 'GBR',<br></span>
                ...
                <!-- --------------------Headers:------------------ -->
                <div id="step2" class="">
                    <p class="bottom-headers"><span class="fw-bold">GET: </span> <a
                            href=""><your-base-url>https://payment.ryzen-pay.com/api/payment/{accId}/p4/getPaymentStatus/{checkout_id}</a>
                    </p>
                    <div class="header-wrapper mt-4">
