...
@section('title')
Documentation > P24-UPI ATM Service
@php
    ...
    <div class="col-xl-12 mt-3 d-flex flex-column flex-lg-row gap-5">
            ...
            <ol class="steps">
                ...
                <li class="step completed">
                    ...
                    <div class="body">
                        ...
                        <p><span class="fw-bold">POST: </span> <a href="#">
                                https://payzone.finpay.group/api/payment/{accId}/p24/checkout </a></p>
                            ...
                            <div class="header-wrapper mt-4">
                                ...
                                <div class="box-content">
                                    <p>
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'CustRefNum'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'ORD12345678',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required, letters & numbers only, 8-32 chars, unique per transaction</span><br>
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'ContactNo'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'9876543210',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            class="comment-text">// Required, 10 digits</span><br>

                                        &nbsp;&nbsp;&nbsp;&nbsp;<span class="pink-text">'EmailId'</span> <span
                                            class="pink-text">=></span> <span
                                            class="blue-text-color">'test@example.com',</span>&nbsp;&nbsp;&nbsp;&nbsp;<span
                ...
                <li class="step completed mt-5 mt-lg-0">
                    ...
                    <div class="body">
                        ...
                        <p><span class="fw-bold">GET: </span> <a
                                href="#">https://&lt;your-base-url&gt;/api/finpay/p24/{checkout_id}</a></p>
                        <p><span class="fw-bold">EXAMPLE: </span>
                            https://www.examplesite.com/api/finpay/p24/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1
                        </p>
                ...
                <li class="step completed mt-5 mt-lg-0">
                    ...
                    <div class="body">
                        ...
                        <p><span class="fw-bold">GET: </span> <a
                                href=""><your-base-url>https://payzone.finpay.group/api/payment/{accId}/p24/getPaymentStatus/{checkout_id}</a>
                        </p>
                                ...
                                <div class="box-content">
                                    <p>
                                        ...
                                        <span class="blue-text-color">{<br>
                                            ...
                                            <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                &nbsp;&nbsp;
                                                &nbsp; &nbsp;"cust_ref_num"</span><span class="pink-text"> =>
                                            </span><span class="blue-text-color"> string,</span><br>
                                            <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                &nbsp;&nbsp;
        ...
        <div class="right-section">
            <div id="step1" class="d-none d-lg-block">
                <p class="px-2"><span class="fw-bold">POST: </span> <a href="#"> https://payzone.finpay.group/api/payment/{accId}/p24/checkout </a></p>
