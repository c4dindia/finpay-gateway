        ...
        <div class="col-xl-12 mt-3 d-flex flex-column flex-lg-row gap-5">
                ...
                <ol class="steps">
                    ...
                    <li class="step completed">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">POST: </span> <a href="#">
                                    https://payment.ryzen-pay.com/api/payment/{accId}/p18/checkout </a></p>
                                ...
                                <span class="blue-text-color">{<br>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'amount'</span> <span
                                            class="pink-text me-2">:</span>"2.52",&nbsp; <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'currency'</span> <span
                                            class="pink-text me-2">:</span>"USD",&nbsp; <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'description'</span> <span
                                            class="pink-text me-2">:</span>"Testing Phase 222",&nbsp; <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'returnUrl'</span> <span
                                            class="pink-text me-2">: </span> "https://www.instragram.com",&nbsp; <span
                                            class="comment-text">//Optional</span> <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'firstName'</span> <span
                                            class="pink-text me-2">:</span>"John",&nbsp; <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'lastName'</span> <span
                                            class="pink-text me-2">:</span>"Mason",&nbsp; <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'email'</span> <span
                                            class="pink-text me-2">:</span>"jm34@mail.com",&nbsp; <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'phone'</span> <span
                                            class="pink-text me-2">:</span>"44 7712346550",&nbsp; <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'streetLine1'</span> <span
                                            class="pink-text me-2">:</span>"7 oadby",&nbsp; <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'stateProvince'</span> <span
                                            class="pink-text me-2">:</span>"Texas",&nbsp; <span
                                            class="comment-text">//Required only for U.S.</span> <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'citizenshipCountryCode'</span> <span
                                            class="pink-text me-2">:</span>"GB",&nbsp; <br></span>
                                    <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        &nbsp;<span class="pink-text">'postalCode'</span> <span
                                            class="pink-text me-2">:</span>"LE2 2DB",&nbsp; <br></span>
                                            ...
                                            <p>
                                                ...
                                                <span class="blue-text-color">{<br>
                                                    ...
                                                    <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp;
                                                        &nbsp;
                                                        &nbsp;"status":</span><span class="blue-text-color">
                                                        "CHECKOUT"</span><br>
                                                    <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp; &nbsp;
                                                        &nbsp;"link":</span><span class="blue-text-color">
                                                        "https://engine-sandbox.keynexpay.com/payment/2b5cc8d913824b239c8b052485ad9ad9",</span><br>
                                                    <span>
                                                        &nbsp; &nbsp;}
                                                    </span><br>
                                                </span>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p18/{checkout_id}</a></p>
                            <p><span class="fw-bold">EXAMPLE: </span>
                                https://www.examplesite.com/api/RyzenPay/p18/1d68304e-xxxx-xxxx-xxxx-xxxxdc2c89e1
                            </p>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        ...
                        <div class="body">
                            ...
                            <p><span class="fw-bold">GET: </span> <a
                                    href=""><your-base-url>https://payment.ryzen-pay.com/api/payment/{accId}/p18/getPaymentStatus/{checkout_id}</a>
                            </p>
                        </div>
            ...
            <div class="right-section">
                        ...
                        <div class="box-content">
                            <p>
                                ...
                                <span class="blue-text-color">{<br>
                                    ...
                                    <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp; &nbsp;
                                        &nbsp;"amount":</span><span class="blue-text-color"> "2.51",</span><br>
                                    <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                                        &nbsp;
                                        &nbsp;"currency":</span><span class="blue-text-color">
                                        "USD",</span><br>
                ...
                <div id="step2" class="d-none d-lg-block bottom-headers">
                    <p><span class="fw-bold">GET: </span> <a
                            href="#">https://&lt;your-base-url&gt;/api/RyzenPay/p18/{checkout_id}</a>
                    </p>
