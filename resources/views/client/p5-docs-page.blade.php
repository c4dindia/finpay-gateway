        ...
        <div class="col-xl-12 mt-3 d-flex flex-column flex-lg-row gap-5">
                ...
                <ol class="steps">
                    ...
                    <li class="step completed">
                        ...
                        <div class="body">
                            ...
                            <p><span>Step 1: </span> API for getting checkout ID</p>
                            <p><span class="fw-bold">POST: </span> <a href="">
                                    https://payment.ryzen-pay.com/api/payment/{accId}/p5/checkout </a></p>
                                    ...
                                    <div class="box-content">
                                        <p>
                                            <span class="blue-text-color">{<br>
                                                ...
                                                <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp; &nbsp;
                                                    &nbsp;"accountId":</span><span class="blue-text-color">
                                                ...
                                                <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                                                    ...
                                                    "https://payment.ryzen-pay.com/payment/p5/payment-page/B471DAED4442Cxxxxxxxxxxxxx.vm-tx01"</span><br>
                                                <span>
                                                    &nbsp;}
                                                </span><br>
                                            </span>
                    ...
                    <li class="step completed mt-5 mt-lg-0">
                        <div class="marker"></div>
                        <div class="body">
                            <h4 class="fw-bold">Step 2: </h4><br> Redirect to this link for proceeding to
                            payment page
                            with checkout id provided in step 1
                            <p><span class="fw-bold">POST: </span> <a
                                    href="">https://payment.ryzen-pay.com/payment/p5/payment-page/{checkout_id}
                                </a></p>
                        </div>
                    </li>
                    <li class="step completed mt-5 mt-lg-0">
                        <div class="marker"></div>
                        <div class="body">
                            <h4 class="fw-bold">Step 3: </h4><br>After the Payment is completed. The page will
                            be
                            redirected to this URL ,i.e.,<span> <a href="#">
                                    &lt;your-base-url&gt;/RyzenPay/p5/checkout-id/{checkout-id}</a></span>
                        </div>
                    </li>
                    <li class="step completed mt-5 mt-lg-0">
                        <div class="marker"></div>
                        <div class="body">
                            ...
                            Transaction Details.
                            <p class="fw-bold mt-4 mb-4">Get Payment Status API:</p>
                            <p><span class="fw-bold">GET: </span> <a
                                    href=""><your-base-url>&lt;your-base-url&gt;api/payment/{accId}/p5/getPaymentStatus/{checkout_id}</a>
                            </p>
                                    ...
                                    <div class="box-content">
                                        <p>
                                            ...
                                            <span class="blue-text-color">[<br>
                                                <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;
                                                    &nbsp; &nbsp;"amount"</span><span class="pink-text">=></span><span
                                                    class="blue-text-color"> string,</span><br>
                                                <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;
                                                    &nbsp; &nbsp;"currency"</span><span class="pink-text">=></span><span
                                                    class="blue-text-color">
                                                    string,</span><br>
                                                <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;
                                                    &nbsp; &nbsp;"accountId"</span><span class="pink-text">=></span><span
                                                    class="blue-text-color">
                                                    string,</span><br>
                                                <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;
                                                ...
                                                <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;
                                                    &nbsp; &nbsp;"payment_id"</span><span class="pink-text">=></span><span
                                                    class="blue-text-color">
                                                    string,</span><br>
                                                <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;
                                                    &nbsp; &nbsp;"payment_status" </span><span
                                                    class="pink-text"><span>=></span><span class="blue-text-color">
                                                        string,</span><br>
                                                    <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                        &nbsp;&nbsp;
            ...
            <div class="right-section">
                <div id="step1" class="d-none d-lg-block">
                    ...
                    <!-- ------------------req body:------------------- -->
                    <p class="text-center mb-0 mt-4 fw-bold"></p>
                    <div class="header-wrapper mt-4">
                        ...
                        <div class="box-content">
                            ...
                            <span class="blue-text-color">{<br>
                                <span> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                    &nbsp;<span class="pink-text">'amount'</span>   <span class="pink-text">=></span>
                                    7.99,<br></span>
                                <span>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                ...
                <div id="step2" class="d-none d-lg-block mt-5">
                    <p><span class="fw-bold">GET: </span> <a
                            href=""><your-base-url>&lt;your-base-url&gt;api/payment/{accId}/p5/getPaymentStatus/{checkout_id}</a>
                    </p>
                        ...
                        <div class="box-content">
                            <p>
                                ...
                                <span class="blue-text-color">[<br>
                                    ...
                                    <span class="pink-text"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;
                                        &nbsp; &nbsp;"payment_status" </span><span class="pink-text"><span>=></span><span
                                            class="blue-text-color">
                                            string,</span><br>
                                        <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;
                                            &nbsp; &nbsp;"description"</span><span class="pink-text">=></span><span
                                            class="blue-text-color">string,</span><br>
                                        <span class="pink-text">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;
                                            &nbsp; &nbsp;"created_at" </span><span class="pink-text">=></span><span
                                            class="blue-text-color">string,</span><br>
