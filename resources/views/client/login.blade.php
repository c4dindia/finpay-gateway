...
<head>
    ...
    <style>
        /* Same first-paint strategy as clientMaster — avoids theme / token flash before index.css */
        html {
        ...
        /* Tokens on .fd-root follow html.is-dark immediately (bottom script also sets .fd-root.is-dark). */
        ...
        <div class="fd-topbar fd-login-topbar">
            <div class="fd-topbar-left">
                ...
                <div class="fd-topbar-titles">
                    <p class="fd-topbar-title mb-0">Client portal</p>
                    <p class="fd-topbar-sub mb-0">Sign in to continue</p>
                </div>
            </div>
        ...
        <main class="fd-shell fd-login-shell flex-grow-1 d-flex flex-column align-items-center justify-content-center">
            <div class="fd-login-card w-100">
                <div class="text-center mb-4">
                    ...
                    <p class="fd-login-lead mb-0">Enter your credentials to access the dashboard.</p>
                </div>

                <form id="login-form" action="{{ route('clientSignIn') }}" method="POST" novalidate>
                    @csrf
                    <div class="mb-3">
