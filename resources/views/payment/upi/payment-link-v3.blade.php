...
<head>
    <meta charset="utf-8">
    <title>UPI Payment V3 Link</title>
        ...
        <div class="page-wrap">
            ...
            <div class="main-card">
                ...
                <form id="generate-form" method="POST">
                    ...
                    <div class="d-flex gap-3 input-row">
                        <div class="input-group-custom flex-fill">
                            <label for="input-amount">Email</label>
                            <div class="input-wrap">
    ...
    <script>
        $(document).ready(function() {
            ...
            function checkInputs() {
                ...
                var hasEmail = email.val().trim() !== '' && email[0].checkValidity();
                var hasUrl = url.val().trim() !== '' && url[0].checkValidity();

                $btn.prop('disabled', !(hasAmount && hasCurrency && hasDescription && hasPhone && hasEmail && hasUrl));
            }
            ...
            function generateLink() {
                ...
                $.ajax({
                    url: '/p23/generate-payment-link/v3',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        amount: amount,
