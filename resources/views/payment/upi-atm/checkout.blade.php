        ...
        <div id="expiredPanel" class="result-sheet result--expired" role="status" aria-live="polite">
            <div class="result-card">
                <div class="result-top">
                    ...
                    @php
                        $expiryMinutes = (int) config('services.p24.payment_expiry_minutes');
                    @endphp
        ...
        (function () {
            ...
            function updateCountdown() {
                ...
                if (diff <= 0) {
                    ...
                    fetch('/p24/payment-expired/' + encodeURIComponent(checkoutId))
            ...
            function startStatusCheck() {
                statusInterval = setInterval(function () {
                    ...
                    fetch('/p24/payment-status/' + encodeURIComponent(checkoutId))
                        .then(function (response) {
                            return response.json();
                        })
                        .then(function (data) {
