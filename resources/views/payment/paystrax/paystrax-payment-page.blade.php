        ...
        <div class="row mt-5 d-flex justify-content-center" style="padding:0 20px;">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 d-flex  flex-column align-items-center payment-card-right-side-wrap" >
                      ...
                      <form action="{{ url('/payment/p1/payment-status') }}/{{ $checkout_id }}" class="paymentWidgets " data-brands="MAESTRO MASTER MASTERDEBIT VISA VISADEBIT VISAELECTRON VPAY RUPAY AMEX" method="get">
                      </form>
                    </div>
