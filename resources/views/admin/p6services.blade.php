...
<div class="p-2 p-lg-4 gap-4">
    ...
    <div class="d-flex flex-column flex-md-row gap-md-5 align-items-center justify-content-center">
        <h6 class="text-center mb-2 mb-md-3" style="Font-family:Poppins; font-weight: 500; line-height: 20px;">LOGIN : <a
                href="https://transvoucher.com/login" target="_blank">https://transvoucher.com/login</a></h6>
        <h6 class="text-center mb-2 mb-md-3" style="Font-family:Poppins; font-weight: 500; line-height: 20px;">(U:
            bobby@c4g.co.uk , Pass: Hellofresh1234!)</h6>
    </div>
    @if (count($p6co) == 0)
        ...
        <table class="table custom-table align-middle all-trans-table">
            <thead>
                <tr>
                    ...
                    <th class="table-header text-center p-3">Sales Channel</th>
                    <th class="table-header text-center p-3">Status</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($p6co as $company)
                <tr class="table-row">
                ...
                <div class=" d-flex justify-content-end align-items-center gap-4 lg:gap-14 mt-4 pr-3 lg:py-5">
                        ...
                        <div class="">
                            <ul class="pagination d-flex align-items-center gap-2">
                                ...
                                @if (!$p6co->onFirstPage())
                                <li class="">
                                    <a class="d-flex align-items-center" href=" {{ $p6co->previousPageUrl() ?? '#' }}">
                                ...
                                @if ($start > 1)
                                <li class=""><a class=" href=" {{ $p6co->url(1) }}" style="color: black">1</a>
                                </li>
                                @if ($start > 2)
                                ...
                                @for ($page = $start; $page <= $end; $page++) <li
                                    ...
                                    @else
                                    <a class="pagination-box" href="{{ $p6co->url($page) }}" style="color: black">{{
                                        $page }}</a>
                                    @endif
                                    </li>
                                    @endfor
                                    ...
                                    @if ($end < $last) @if ($end < $last - 1) <li class=" "><span
                                        ...
                                        @endif
                                        <li class=""><a class="" href=" {{ $p6co->url($last) }}" style="color: black">{{
                                                $last }}</a>
                                        </li>
                                        @endif
                                        {{-- Next --}}
                                        @if ($p6co->hasMorePages())
                                        <li class="">
                                            <a class="d-flex align-items-center"
                                                href="{{ $p6co->nextPageUrl() ?? '#' }}">
                                                <svg width="16" height="14" viewBox="0 0 16 14" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
