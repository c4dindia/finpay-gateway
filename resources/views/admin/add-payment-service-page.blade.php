            ...
            <form action="{{ route('assignPMtoComapany') }}" method="POST">
                ...
                <div class="input-group">
                    <select class="form-select p-3" name="selectPaymentPartner" id="selectPaymentPartner" required>
                        <option value="" selected disabled>Select Payment partner</option>
                        {{-- <option value="PGTechPay">P-12 PGTech</option>
                            <option value="Direpay">P-17 Dire Pay</option>
                            <option value="UniqoPay">P-22 Uniqo Pay</option> --}}
