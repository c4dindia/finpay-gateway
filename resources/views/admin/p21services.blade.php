                    ...
                    <div class="col-12 col-sm-6 p-2">
                        <div class="col-12 ind-card">
                            ...
                            <div class="col-12 d-flex align-items-start py-1">
                                ...
                                <div
                                    class="col-2 @if ($company->status == '1') statusSuccess @else statusdanger @endif"">
                                    @if ($company->status == '1')
                                        Active
                                    @else
                                        Deactivated
                ...
                <div class=" d-flex justify-content-end align-items-center gap-4 lg:gap-14 mt-4 pr-3 lg:py-5">
                    ...
                    <div class="">
                        <ul class="pagination d-flex align-items-center gap-2">
                            {{-- Prev --}}
                            @if (!$p21co->onFirstPage())
                                <li class="">
                                    <a class="d-flex align-items-center" href=" {{ $p21co->previousPageUrl() ?? '#' }}">
                            ...
                            @if ($start > 1)
                                <li class=""><a class=" href=" {{ $p21co->url(1) }}" style="color: black">1</a>
                                </li>
                                @if ($start > 2)
                            ...
                            @for ($page = $start; $page <= $end; $page++)
                                <li
                                    ...
                                    @else
                                        <a class="pagination-box" href="{{ $p21co->url($page) }}"
                            ...
                            @if ($end < $last)
                                ...
                                @endif
                                <li class=""><a class="" href=" {{ $p21co->url($last) }}"
                                        style="color: black">{{ $last }}</a>
                                </li>
                            @endif
                            {{-- Next --}}
                            @if ($p21co->hasMorePages())
                                <li class="">
                                    <a class="d-flex align-items-center" href="{{ $p21co->nextPageUrl() ?? '#' }}">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
