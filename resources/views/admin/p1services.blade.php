                ...
                <div class="d-flex justify-content-end align-items-center gap-4 lg:gap-14 mt-4 pr-3 lg:py-5">
                    ...
                    <div class="">
                        <ul class="pagination d-flex align-items-center gap-2">
                            ...
                            @if (!$p1co->onFirstPage())
                                <li class="">
                                    <a class="d-flex align-items-center" href=" {{ $p1co->previousPageUrl() ?? '#' }}">
                            ...
                            @if ($start > 1)
                                <li class=""><a class=" href=" {{ $p1co->url(1) }}" style="color: black">1</a>
                                </li>
                                @if ($start > 2)
                            ...
                            @for ($page = $start; $page <= $end; $page++)
                                <li class=" {{ $page === $current ? 'pagination-box-active' : 'pagination-box-inactive'}}">
                                    ...
                                    @else
                                        <a class="pagination-box" href="{{ $p1co->url($page) }}"
                            ...
                            @if ($end < $last) @if ($end < $last - 1)
                                ...
                                @endif
                                <li class=""><a class="" href=" {{ $p1co->url($last) }}" style="color: black">{{ $last }}</a>
                                </li>
                            @endif
                            {{-- Next --}}
                            @if ($p1co->hasMorePages())
                                <li class="">
                                    <a class="d-flex align-items-center" href="{{ $p1co->nextPageUrl() ?? '#' }}">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
