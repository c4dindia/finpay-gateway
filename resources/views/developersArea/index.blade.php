...
<div class="row mx-0">
    ...
    <div class="row doc-grid mx-0">
        ...
        @if (!empty($p24detail->b_token))
        <!-- Pay By Link Atompay (UPI ATM) -->
        <div class="col-12 col-sm-6 col-xl-4 py-3">
            <button type="button" class="btn doc-card w-100 fd-docTile" data-bs-toggle="modal" data-bs-target="#exampleModalAtompay" data-bs-whatever="pbl-x">
                <div class="fd-docTile__top">
                    <span class="fd-docTile__icon" aria-hidden="true">
                        <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="fd-docTile__title">Pay-By-Link (Upi ATM)</div>
            </button>
        </div>
        <!-- Modal -->
        <div class="modal fade" id="exampleModalAtompay" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered da-modal">
                <div class="modal-content da-modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Pay-By-Link (Upi ATM)</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body da-modal-body">
                        <p class="d-flex flex-column align-items-start"><span class="grey-heading font-400 mb-2 ">Notification URL :
                            </span><span class="font-500">{{ $p24detail->redirect_url }}/api/finpay/p24/{checkout_id}</span>
                        </p>
                        <p class="d-flex flex-column align-items-start"><span class="grey-heading font-400 mb-2 ">Bearer Token : </span>
                            <span class="font-500">{{ $p24detail->b_token }}</span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        @if (!empty($p25detail->b_token))
        <!-- Pay By Link Paynora (UPI PYN) -->
        <div class="col-12 col-sm-6 col-xl-4 py-3">
            <button type="button" class="btn doc-card w-100 fd-docTile" data-bs-toggle="modal" data-bs-target="#exampleModalPaynora" data-bs-whatever="pbl-x">
                <div class="fd-docTile__top">
                    <span class="fd-docTile__icon" aria-hidden="true">
                        <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="fd-docTile__title">Pay-By-Link (Upi PYN)</div>
            </button>
        </div>
        <!-- Modal -->
        <div class="modal fade" id="exampleModalPaynora" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered da-modal">
                <div class="modal-content da-modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Pay-By-Link (Upi PYN)</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body da-modal-body">
                        <p class="d-flex flex-column align-items-start"><span class="grey-heading font-400 mb-2 ">Notification URL :
                            </span><span class="font-500">{{ $p25detail->redirect_url }}/api/finpay/p25/{checkout_id}</span>
                        </p>
                        <p class="d-flex flex-column align-items-start"><span class="grey-heading font-400 mb-2 ">Bearer Token : </span>
                            <span class="font-500">{{ $p25detail->b_token }}</span>
                        </p>
                    </div>
                </div>
            </div>
